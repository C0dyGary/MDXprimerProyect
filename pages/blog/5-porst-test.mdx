...
<img
  src="https://i.ibb.co/0qkJzWs/Captura-de-pantalla-37.png"
  width="auto"
  alt="Captura-de-pantalla-37"
  border="0"
  className="p-2"
/>
<img
  src="https://i.ibb.co/gvYzMpH/Captura-de-pantalla-35.png"
  width="auto"
  alt="Captura-de-pantalla-35"
  border="0"
  center="auto"
  className="p-2"
/>
